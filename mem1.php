    ...
    <div class="header_resize">
      <div class="menu_nav">
        <ul>
          ...
          <li class="active"><a href="mem.php"><span>Logged In</span></a></li>
  ...
  <div class="fbg">
    <div class="fbg_resize">
      <div class="col c1">
	   ...
	   <?php 
	     echo "<p>Dear $username ,</p>";
		 ?>
        <h2>Booking Successful!!</h2>
        <p>Hope you enjoy your Holidays!!</p>
       
      
	   <p>We are happy to service you.<br>
